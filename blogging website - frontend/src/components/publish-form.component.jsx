...
// creating tags 
    ...
    const publishblog = (e)=>{
        ...
        if(!tags.length)
        {
            return toast.error("Write at least 1 tag")
        }
    ...
    return(
         <AnimationWrapper>
            ...
            <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
                ...
                <div className="border-grey lg:border-1 ld:pl-8">
                    <p className="text-dark-grey mb-2 mt-9">Blog Title</p>
                    <input type="text" placeholder="Blog Title" defaultValue={title} className="input-box pl-4" onChange={handleTitleChange}/>
